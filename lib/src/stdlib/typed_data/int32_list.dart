  ...
  static BridgedClass get definition => BridgedClass(
        ...
        constructors: {
          '': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError("Int32List constructor expects one int argument (length).");
          },
          'fromList': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError("Int32List.fromList expects one List<int> argument.");
          },
          'view': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError("Int32List.view expects ByteBuffer and optional offset/length arguments.");
          },
          'sublistView': (visitor, positionalArgs, namedArgs) {
            ...
            throw RuntimeError("Int32List.sublistView expects TypedData and optional start/end arguments.");
          },
        },
        methods: {
          ...
          '[]=': (visitor, target, positionalArgs, namedArgs) {
            ...
            throw RuntimeError("Int32List[index] = value expects int index and int value.");
          },
        ...
        getters: {
          ...
          'lengthInBytes': (visitor, target) => (target as Int32List).lengthInBytes,
          'offsetInBytes': (visitor, target) => (target as Int32List).offsetInBytes,
